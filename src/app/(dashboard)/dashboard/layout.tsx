...
const Layout = async ({ children }: LayoutProps) => {
  ...
  return (
    ...
    <header className="w-full bg-gradient-to-r from-cyan-200 to-teal-300 shadow-lg p-4 flex items-center justify-between">
      <div className=" flexjustify-self-start">
      <Link
            href="/dashboard"
