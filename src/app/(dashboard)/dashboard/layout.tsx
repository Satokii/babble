          ...
          <ul role="list" className="flex flex-1 flex-col gap-y-6">
            ...
            <li className="mt-auto flex items-center">
              <Link
                ...
                className="transition rounded-md duration-300 ease-in-out hover:bg-cyan-500"
              >
                <div className="flex flex-1 items-center gap-x-3 px-1 py-2 text-sm font-semibold leading-5 text-gray-900">
